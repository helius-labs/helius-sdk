...
- fix(websockets): Type and Document `maxSupportedTransactionVersion` for v1 [`#349`](https://github.com/helius-labs/helius-sdk/pull/349)
- fix(txn): Always Set the v1 `loaded-accounts-data-size` Limit [`#348`](https://github.com/helius-labs/helius-sdk/pull/348)
- fix(txns): Report Onchain Failures From Poll Expiry Path [`#347`](https://github.com/helius-labs/helius-sdk/pull/347)
- feat(rpc): Expose Transport Augmentation Hook [`#346`](https://github.com/helius-labs/helius-sdk/pull/346)
- fix(websockets): guard raw subscriptions against reopening after close() [`#340`](https://github.com/helius-labs/helius-sdk/pull/340)
- fix(deps): Patch 17 Transitive Dev Dep Advisories via pnpm overrides [`#344`](https://github.com/helius-labs/helius-sdk/pull/344)
- fix(staking): fix epoch boundary in getWithdrawableAmount [`#339`](https://github.com/helius-labs/helius-sdk/pull/339)

### Fixed

- fix(websockets): guard raw subscriptions against reopening after close() (#340) [`#338`](https://github.com/helius-labs/helius-sdk/issues/338)
- fix(staking): fix epoch boundary in getWithdrawableAmount (#339) [`#337`](https://github.com/helius-labs/helius-sdk/issues/337)

## [v3.1.0](https://github.com/helius-labs/helius-sdk/compare/v3.0.0...v3.1.0) - 2026-08-15

### Merged

- feat(transactions): Support Transaction v1 For Larger Transactions [`#341`](https://github.com/helius-labs/helius-sdk/pull/341)
- fix(staking): accept initialized stake accounts in getWithdrawableAmount [`#336`](https://github.com/helius-labs/helius-sdk/pull/336)
- feat(sender): Sender Max pricing + Pre Confirmations (preconfSubscribe) [`#335`](https://github.com/helius-labs/helius-sdk/pull/335)
- feat(wallet): Add `getBalanceAt` For Historical Token Balances [`#334`](https://github.com/helius-labs/helius-sdk/pull/334)
- fix(examples): Correct zk getCompressedTokenAccountsByOwner example filename [`#332`](https://github.com/helius-labs/helius-sdk/pull/332)
- Require and Enforce Signed Commits [`#333`](https://github.com/helius-labs/helius-sdk/pull/333)

## [v3.0.0](https://github.com/helius-labs/helius-sdk/compare/v2.2.2...v3.0.0) - 2026-06-01

### Merged

- feat(auth): oauthTokenExchange primitive + HELIUS_API_URL env override [`#329`](https://github.com/helius-labs/helius-sdk/pull/329)
- Migrate v0 REST Endpoints to api-mainnet.helius-rpc.com [`#328`](https://github.com/helius-labs/helius-sdk/pull/328)
- Add Auth Examples [`#327`](https://github.com/helius-labs/helius-sdk/pull/327)
- Add Typecheck Gate [`#326`](https://github.com/helius-labs/helius-sdk/pull/326)
- docs(agents): Replace Removed `agenticSignup` Ref with `signupAndPay` [`#324`](https://github.com/helius-labs/helius-sdk/pull/324)
- docs(copilot): Refresh stale src/auth/ sketch [`#325`](https://github.com/helius-labs/helius-sdk/pull/325)
- Satisft Kit's Header Type at Transport Call Sites [`#323`](https://github.com/helius-labs/helius-sdk/pull/323)
- chore(deps): Bump `@solana/kit`  [`#322`](https://github.com/helius-labs/helius-sdk/pull/322)
- chore(meta): Fill Out `package.json` and Restrict Published Files [`#320`](https://github.com/helius-labs/helius-sdk/pull/320)
- fix(auth): Circular Dep and Stale tsc Errors [`#319`](https://github.com/helius-labs/helius-sdk/pull/319)
- Add SECURITY.md [`#318`](https://github.com/helius-labs/helius-sdk/pull/318)
- chore(deps): Patch Transitive Vulns via pnpm Overrides [`#316`](https://github.com/helius-labs/helius-sdk/pull/316)
- Pin pnpm SHA and Clean Up Workflows [`#317`](https://github.com/helius-labs/helius-sdk/pull/317)
- chore(auth): clean up legacy signup + checkout code [`#314`](https://github.com/helius-labs/helius-sdk/pull/314)
- feat(auth): unified signup via crypto checkout payment link [`#312`](https://github.com/helius-labs/helius-sdk/pull/312)
- Add getTransfersByAddress RPC method [`#313`](https://github.com/helius-labs/helius-sdk/pull/313)
- feat(auth): Agent Plan signup + prepaid-credits top-up; migrate to stripe.priceIds [`#309`](https://github.com/helius-labs/helius-sdk/pull/309)
- Add Pre-Commit Auto-formatting via simple-git-hooks [`#308`](https://github.com/helius-labs/helius-sdk/pull/308)
- Runs formatter [`#307`](https://github.com/helius-labs/helius-sdk/pull/307)
- Adds initial Admin API support to `helius-sdk` [`#305`](https://github.com/helius-labs/helius-sdk/pull/305)
- Add token account fields to transaction types [`#301`](https://github.com/helius-labs/helius-sdk/pull/301)
- docs: update LaserStream pricing and business plan access [`#304`](https://github.com/helius-labs/helius-sdk/pull/304)
- feat(auth): Unify Signup on Checkout and Add Sponsored Mode [`#298`](https://github.com/helius-labs/helius-sdk/pull/298)
- Implement Webhook Toggle [`#297`](https://github.com/helius-labs/helius-sdk/pull/297)
- Update AGENTS.md to Reflect Auth Namespace on HeliusClient [`#296`](https://github.com/helius-labs/helius-sdk/pull/296)
- feat(ws): add Enhanced WebSocket transaction & account subscriptions [`#295`](https://github.com/helius-labs/helius-sdk/pull/295)
- fix: pass customer info through executeUpgrade [`#294`](https://github.com/helius-labs/helius-sdk/pull/294)
- fix(types): `HeliusClient` Collapsing to `any` [`#292`](https://github.com/helius-labs/helius-sdk/pull/292)
- fix(ci): Better Publish Workflow [`#291`](https://github.com/helius-labs/helius-sdk/pull/291)
